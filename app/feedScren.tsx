          ...
          <View className="flex-1 p-4 bg-white">
            ...
            <ScrollView>
              ...
              >
                ...
                <Text className="mt-1 text-gray-600">Encontre serviços de construção para seu projeto.</Text>
              </TouchableOpacity>
              ...
              >
                ...
                <Text className="mt-1 text-gray-600">Descubra serviços de jardinagem e paisagismo.</Text>
              </TouchableOpacity>
              ...
              >
                ...
                <Text className="mt-1 text-gray-600">Encontre profissionais para serviços elétricos.</Text>
              </TouchableOpacity>
              ...
              >
                <Image
                  source={{ uri: 'https://example.com/encanamento.jpg' }} // Substitua com o link da imagem
                  style={{ width: '100%', height: 200, borderRadius: 8 }}
                />
                <Text className="mt-2 text-xl font-semibold">Encanamento</Text>
                <Text className="mt-1 text-gray-600">Serviços de encanamento para sua residência ou empresa.</Text>
              </TouchableOpacity>
            </ScrollView>
          </View>
